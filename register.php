        ...
        <form action="./register.php" method="POST">
         ...
         <?php include("./includes/formErrors.php") ?>
            ...
            <div class="form-group">
                ...
                <input type="email" class="form-control" value="<?php echo $email ?>" name="email" placeholder="" />
            </div>
            ...
            <div class="form-group">
                ...
                <input type="password" class="form-control" value="<?php echo $confirm_password ?>"
                    name="confirm-password" placeholder="" />
            </div>

            <div class="sign-register">
                <button type="submit" name="btn-register" class="btn btn-lg btn-success">
                    Register
                </button>
